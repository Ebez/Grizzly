...
public class WiredUserSaysKeyWordInteraction implements Interaction {
   ...
   public void onTrigger(Session Session, Object Item, int Request) {
      if(Request != 2) {
         ...
         Session.sendResponse(SendWiredTriggerDialogComposer.compose(0, RoomItem, new ArrayList(), RoomItem.ExtraData, 0, 0, 0, 0, 0));
      }
